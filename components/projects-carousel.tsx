  ...
  const projects = [
    {
      ...
      image: "/FixPoint.png",
      technologies: [
        "TypeScript 99.6%", "Other 0.4%", "Next.js (React, App Router)", "TailwindCSS", "Axios para requests", "NestJS", "TypeORM", "PostgreSQL", "JWT para autenticación"],
    ...
    },
    {
      ...
      image: "/SwaggerApi.png",
        technologies: ["TypeScript 97.5%", "Javascript 2.5%"],
